...
export function contractObject(contract) {
    ...
    const contractObj = {
        ...
        hasAmendments: (contract.modificaciones == 'Sí')? true : false
    };
...
export function supplierPartyObject(contract) {
    ...
    const party = {
        ...
        roles: ['supplier'],
        details: {},
        identifier: { id: contract.cedula_adjudicatario }
    }
    ...
    if(contract.hasOwnProperty('proveedor') && contract.proveedor != null) {
        ...
        if(country == undefined) console.log(contract.proveedor.nacionalidad);

        Object.assign(party.details, { scaleReportedBySupplierMxCnet: contract.proveedor.tipo, type: getPartyType(contract.adjudicatario, contract.proveedor.cedula) });
        ...
        let partyType = getPartyType(contract.adjudicatario, contract.cedula_adjudicatario);
...
export function buyerPartyObject(contract) {
    ...
    if(geoInfo.hasOwnProperty('municipio')) Object.assign(party.address, { state: geoInfo.provincia, locality: geoInfo.municipio });
...
function getAdministrativeInfo(institution) {
    switch(institution) {
        ...
        case "Asociación de Desarrollo Integral de Villa Bonita": return { govLevel: "Municipal", provincia: "Alajuela", municipio: "Alajuela" }
        case "Comité Cantonal de Deportes y Recreación de Alajuela": return { govLevel: "Municipal", provincia: "Alajuela", municipio: "Alajuela" }
        case "Comité Cantonal de Deportes y Recreación de Belén": return { govLevel: "Municipal", provincia: "Heredia", municipio: "Belén" }
        case "COMITÉ CANTONAL DE DEPORTES Y RECREACIÓN DE CARTAGO": return { govLevel: "Municipal", provincia: "Cartago", municipio: "Cartago" }
        case "COMITE CANTONAL DE DEPORTES Y RECREACION DE ESCAZU": return { govLevel: "Municipal", provincia: "San José", municipio: "Escazú" }
        case "COMITE CANTONAL DE DEPORTES Y RECREACION DE HEREDIA": return { govLevel: "Municipal", provincia: "Heredia", municipio: "Heredia" }
        case "Comité Cantonal de Deportes y Recreación de Liberia": return { govLevel: "Municipal", provincia: "Guanacaste", municipio: "Liberia" }
        case "COMITE CANTONAL DE DEPORTES Y RECREACION DE MORAVIA": return { govLevel: "Municipal", provincia: "San José", municipio: "Moravia" }
        case "Comité Cantonal de Deportes y Recreación de Paraíso": return { govLevel: "Municipal", provincia: "Cartago", municipio: "Paraíso" }
        case "Comité Cantonal de Deportes y Recreación de Pérez Zeledón": return { govLevel: "Municipal", provincia: "San José", municipio: "Pérez Zeledón" }
        case "Concejo Municipal de Distrito de Colorado": return { govLevel: "Municipal", provincia: "Guanacaste", municipio: "Abangares" }
        case "Concejo Municipal de Distrito de Lepanto": return { govLevel: "Municipal", provincia: "Puntarenas", municipio: "Puntarenas" }
        case "Concejo Municipal de Distrito de Monte Verde": return { govLevel: "Municipal", provincia: "Puntarenas", municipio: "Puntarenas" }
        case "MUNICIPALIDAD DE ACOSTA": return { govLevel: "Municipal", provincia: "San José", municipio: "Acosta" }
        case "Municipalidad de Alajuela": return { govLevel: "Municipal", provincia: "Alajuela", municipio: "Alajuela" }
        case "Municipalidad de Alajuelita": return { govLevel: "Municipal", provincia: "San José", municipio: "Alajuelita" }
        case "MUNICIPALIDAD DE ALVARADO DE PACAYAS": return { govLevel: "Municipal", provincia: "Cartago", municipio: "Pacayas" }
        case "Municipalidad de Aserri": return { govLevel: "Municipal", provincia: "San José", municipio: "Aserrí" }
        case "Municipalidad de Atenas": return { govLevel: "Municipal", provincia: "Alajuela", municipio: "Atenas" }
        case "Municipalidad de Barva": return { govLevel: "Municipal", provincia: "Heredia", municipio: "Barva" }
        case "Municipalidad de Belén": return { govLevel: "Municipal", provincia: "Heredia", municipio: "Belén" }
        case "Municipalidad de Buenos Aires": return { govLevel: "Municipal", provincia: "Puntarenas", municipio: "Buenos Aires" }
        case "Municipalidad de Carrillo": return { govLevel: "Municipal", provincia: "Guanacaste", municipio: "Carrillo" }
        case "Municipalidad de Cartago": return { govLevel: "Municipal", provincia: "Cartago", municipio: "Cartago" }
        case "MUNICIPALIDAD DE CORREDORES": return { govLevel: "Municipal", provincia: "Puntarenas", municipio: "Corredores" }
        case "Municipalidad de Coto Brus": return { govLevel: "Municipal", provincia: "Puntarenas", municipio: "Coto Brus" }
        case "Municipalidad de Curridabat": return { govLevel: "Municipal", provincia: "San José", municipio: "Curridabat" }
        case "MUNICIPALIDAD DE DESAMPARADOS": return { govLevel: "Municipal", provincia: "San José", municipio: "Desamparados" }
        case "MUNICIPALIDAD DE EL GUARCO": return { govLevel: "Municipal", provincia: "Cartago", municipio: "El Guarco" }
        case "Municipalidad de Escazu": return { govLevel: "Municipal", provincia: "San José", municipio: "Escazú" }
        case "MUNICIPALIDAD DE ESPARZA": return { govLevel: "Municipal", provincia: "Puntarenas", municipio: "Esparza" }
        case "MUNICIPALIDAD DE GARABITO": return { govLevel: "Municipal", provincia: "Puntarenas", municipio: "Garabito" }
        case "Municipalidad de Golfito": return { govLevel: "Municipal", provincia: "Puntarenas", municipio: "Golfito" }
        case "Municipalidad de Grecia": return { govLevel: "Municipal", provincia: "Alajuela", municipio: "Grecia" }
        case "MUNICIPALIDAD DE GUÁCIMO": return { govLevel: "Municipal", provincia: "Limón", municipio: "Guácimo" }
        case "Municipalidad de Heredia": return { govLevel: "Municipal", provincia: "Heredia", municipio: "Heredia" }
        case "Municipalidad de Jiménez de Cartago": return { govLevel: "Municipal", provincia: "Cartago", municipio: "Jímenez" }
        case "MUNICIPALIDAD DE LA UNION": return { govLevel: "Municipal", provincia: "Cartago", municipio: "La Unión" }
        case "MUNICIPALIDAD DE LEON CORTES": return { govLevel: "Municipal", provincia: "San José", municipio: "León Cortés" }
        case "Municipalidad de Liberia": return { govLevel: "Municipal", provincia: "Guanacaste", municipio: "Liberia" }
        case "MUNICIPALIDAD DE LIMON": return { govLevel: "Municipal", provincia: "Limón", municipio: "Limón" }
        case "Municipalidad de Los Chiles": return { govLevel: "Municipal", provincia: "Alajuela", municipio: "Los Chiles" }
        case "MUNICIPALIDAD DE MATINA": return { govLevel: "Municipal", provincia: "Limón", municipio: "Matina" }
        case "Municipalidad de Montes de Oca": return { govLevel: "Municipal", provincia: "San José", municipio: "Montes de Oca" }
        case "Municipalidad de Montes de Oro": return { govLevel: "Municipal", provincia: "Puntarenas", municipio: "Montes de Oro" }
        case "MUNICIPALIDAD DE MORA": return { govLevel: "Municipal", provincia: "San José", municipio: "Mora" }
        case "Municipalidad de Moravia": return { govLevel: "Municipal", provincia: "San José", municipio: "Moravia" }
        case "MUNICIPALIDAD DE NARANJO": return { govLevel: "Municipal", provincia: "Alajuela", municipio: "Naranjo" }
        case "Municipalidad de Oreamuno": return { govLevel: "Municipal", provincia: "Cartago", municipio: "Oreamuno" }
        case "MUNICIPALIDAD DE OROTINA": return { govLevel: "Municipal", provincia: "Alajuela", municipio: "Orotina" }
        case "Municipalidad de Osa": return { govLevel: "Municipal", provincia: "Puntarenas", municipio: "Osa" }
        case "MUNICIPALIDAD DE PALMARES.": return { govLevel: "Municipal", provincia: "Alajuela", municipio: "Palmares" }
        case "Municipalidad de Paraíso": return { govLevel: "Municipal", provincia: "Cartago", municipio: "Paraíso" }
        case "MUNICIPALIDAD DE PARRITA": return { govLevel: "Municipal", provincia: "Puntarenas", municipio: "Parrita" }
        case "Municipalidad de Perez Zeledón": return { govLevel: "Municipal", provincia: "San José", municipio: "Pérez Zeledón" }
        case "Municipalidad de Poás": return { govLevel: "Municipal", provincia: "Alajuela", municipio: "Poás" }
        case "Municipalidad de Pococí": return { govLevel: "Municipal", provincia: "Limón", municipio: "Pococí" }
        case "Municipalidad de Puntarenas": return { govLevel: "Municipal", provincia: "Puntarenas", municipio: "Puntarenas" }
        case "Municipalidad de Puriscal": return { govLevel: "Municipal", provincia: "San José", municipio: "Puriscal" }
        case "Municipalidad de Quepos": return { govLevel: "Municipal", provincia: "Puntarenas", municipio: "Quepos" }
        case "Municipalidad de Río Cuarto": return { govLevel: "Municipal", provincia: "Alajuela", municipio: "Río Cuarto" }
        case "Municipalidad de San Carlos": return { govLevel: "Municipal", provincia: "Alajuela", municipio: "San Carlos" }
        case "MUNICIPALIDAD DE SAN ISIDRO DE HEREDIA": return { govLevel: "Municipal", provincia: "Heredia", municipio: "San Isidro" }
        case "MUNICIPALIDAD DE SAN JOSE": return { govLevel: "Municipal", provincia: "San José", municipio: "San José" }
        case "MUNICIPALIDAD DE SAN MATEO": return { govLevel: "Municipal", provincia: "Alajuela", municipio: "San Mateo" }
        case "MUNICIPALIDAD DE SAN PABLO DE HEREDIA": return { govLevel: "Municipal", provincia: "Heredia", municipio: "San Pablo" }
        case "MUNICIPALIDAD DE SAN RAFAEL DE HEREDIA": return { govLevel: "Municipal", provincia: "Heredia", municipio: "San Rafael" }
        case "MUNICIPALIDAD DE SAN RAMON": return { govLevel: "Municipal", provincia: "Alajuela", municipio: "San Ramón" }
        case "MUNICIPALIDAD DE SANTA ANA": return { govLevel: "Municipal", provincia: "San José", municipio: "Santa Ana" }
        case "Municipalidad de Santa Barbara": return { govLevel: "Municipal", provincia: "Heredia", municipio: "Santa Bárbara" }
        case "Municipalidad de Santa Cruz": return { govLevel: "Municipal", provincia: "Guanacaste", municipio: "Santa Cruz" }
        case "MUNICIPALIDAD DE SANTO DOMINGO": return { govLevel: "Municipal", provincia: "Heredia", municipio: "Santo Domingo" }
        case "Municipalidad de Sarapiquí": return { govLevel: "Municipal", provincia: "Heredia", municipio: "Sarapiquí" }
        case "MUNICIPALIDAD DE SARCHI": return { govLevel: "Municipal", provincia: "Alajuela", municipio: "Sarchí" }
        case "Municipalidad de Talamanca": return { govLevel: "Municipal", provincia: "Limón", municipio: "Talamanca" }
        case "Municipalidad de Tarrazú": return { govLevel: "Municipal", provincia: "San José", municipio: "Tarrazú" }
        case "Municipalidad de Tibás": return { govLevel: "Municipal", provincia: "San José", municipio: "Tibás" }
        case "Municipalidad de Tilarán": return { govLevel: "Municipal", provincia: "Guanacaste", municipio: "Tilarán" }
        case "MUNICIPALIDAD DE TURRIALBA": return { govLevel: "Municipal", provincia: "Cartago", municipio: "Turrialba" }
        case "Municipalidad de Turrubares": return { govLevel: "Municipal", provincia: "San José", municipio: "Turrubares" }
        case "MUNICIPALIDAD DE UPALA": return { govLevel: "Municipal", provincia: "Alajuela", municipio: "Upala" }
        case "Municipalidad de Zarcero": return { govLevel: "Municipal", provincia: "Alajuela", municipio: "Zarcero" }
        case "Municipalidad del Cantón de Flores": return { govLevel: "Municipal", provincia: "Heredia", municipio: "Flores" }
        case "Municipalidad Vázquez De Coronado": return { govLevel: "Municipal", provincia: "San José", municipio: "Vázquez De Coronado" }
...
export function releaseObject({contract, metadata}) {
    ...
    const release = {
        ...
        date: contract.fecha_notificacion,
