...
export function tenderObject(contract) {
    ...
    const partyName = (nombreDependencia != contract.CONTRACT_UC_STRING)? contract.CONTRACT_UC_STRING : nombreDependencia;
    const partyID = (nombreDependencia != contract.CONTRACT_UC_STRING)? contract.CONTRACT_UC_STRING + ' ' + nombreDependencia : nombreDependencia;
