...
const buildExchangeRatesList = require('./exchangeRates');
const commandLineArgs = require('command-line-args');
const optionDefinitions = [
    { name: 'transformer', alias: 't', type: String },
    { name: 'exchangeRates', alias: 'e', type: String, multiple: true }
];
...
if(args.exchangeRates) {
    exchangeRates = buildExchangeRatesList(args.exchangeRates);
}
